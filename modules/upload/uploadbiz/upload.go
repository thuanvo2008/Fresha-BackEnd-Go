...
import (
	...
	"DemoProject/modules/upload/uploadmodel"
	"bytes"
	"context"
	"fmt"
	"image"
...
func NewUploadBiz(provider uploadprovider.UploadProvider, imgStore CreateUploadStorage) *uploadBiz {
...
func (biz *uploadBiz) Upload(ctx context.Context, data []byte, folder, fileName string) (*common.Image, error) {
	...
	img, err := biz.provider.SaveFileProvider(ctx, data, fmt.Sprintf("%s/%s", folder, fileName))
